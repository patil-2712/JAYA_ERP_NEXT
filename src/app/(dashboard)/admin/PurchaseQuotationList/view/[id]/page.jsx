...
import { 
  ...
  FaWarehouse, FaHistory, FaSpinner, FaClipboardList
} from 'react-icons/fa';
...
export default function PurchaseQuotationView() {
  ...
  if (loading) return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      ...
      <p className="text-gray-400 font-bold uppercase text-xs tracking-widest">Fetching Quotation Details...</p>
    </div>
  );
                ...
                <table className="min-w-full divide-y divide-gray-100">
                  <thead className="bg-gray-50/50">
                    <tr className="text-[10px] font-black uppercase tracking-widest text-gray-400">
                      ...
                      <th className="px-6 py-4 text-center">Tax / Price</th>
                      ...
                      <tr key={idx} className="hover:bg-gray-50/30 transition-colors">
                        ...
                        <td className="px-6 py-6 text-center">
                          ...
                          <div className="flex items-center justify-center gap-1 mt-1 text-gray-400">
                            <FaWarehouse size={10} />
                            <span className="text-[10px] font-bold uppercase">{item.warehouseName || 'General Store'}</span>
                          </div>
                        </td>
                        <td className="px-6 py-6 text-center">
                          <p className="text-[11px] font-black text-gray-700">{formatCurrency(item.unitPrice)}</p>
                          <p className="text-[9px] text-indigo-600 font-bold mt-1 tracking-tighter uppercase">{item.taxOption}: {item.gstRate}%</p>
                        </td>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-slate-900 rounded-[2.5rem] shadow-2xl p-8 text-white">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="font-mono text-emerald-400">{formatCurrency(quotation.gstTotal)}</span>
                </div>
                <div className="flex justify-between items-center text-xs border-b border-white/10 pb-5">
                  <span className="opacity-50 font-bold uppercase">Freight / Delivery</span>
                  <span className="font-mono">{formatCurrency(quotation.freight)}</span>
                </div>
                <div className="pt-4">
                  <span className="text-[10px] font-black opacity-40 uppercase block mb-1">Estimated Net Total</span>
            ...
            <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 space-y-5">
                ...
                <DetailField label="Validity End Date" value={formatDate(quotation.validUntil)} color="text-rose-600" />
            ...
            {/* Attachments */}
            <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden">
              <SectionHeader icon={FaPaperclip} title="Source Files" color="purple" />
              <div className="p-6">
                    ...
                    {quotation.attachments.map((file, idx) => (
                      <a key={idx} href={file.fileUrl} target="_blank" rel="noopener noreferrer"
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-[9px] text-gray-400 font-bold uppercase mt-0.5 tracking-tighter">View Doc</p>
                        </div>
                      </a>
                    ))}
                  </div>
            ...
            <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                <DetailField label="Database Entry" value={formatDate(quotation.createdAt)} />
              </div>
            </div>
