...
export default function SocialCampaignStudio() {
  ...
  const fetchTrending = async () => {
    ...
    try {
      ...
      setTrending(JSON.parse(text.replace(/```json|```/g, "").trim()));
    } catch {}
  ...
  const generateCaption = async () => {
    ...
    try {
      ...
      setGenCaptions(JSON.parse(text.replace(/```json|```/g, "").trim()));
    } catch {}
  ...
  const generateHashtags = async () => {
    ...
    try {
      ...
      setGenHashtags(JSON.parse(text.replace(/```json|```/g, "").trim()));
    } catch {}
  ...
  const suggestTimes = async () => {
    ...
    try {
      ...
      setSugTimes(JSON.parse(text.replace(/```json|```/g, "").trim()));
    } catch {}
